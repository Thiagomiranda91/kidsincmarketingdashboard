...
`/contact-form` (linked from the nav bar as "Contact Form") lists the most
recent Contact Form 7 submissions, pulled from the Flamingo plugin on your
WordPress site: date, name, email, subject, and a preview of the message.
You can switch between the last 20 / 50 / 100 submissions.
...
supports a `?limit=` query param (used by the "Last 20/50/100" buttons on the
Contact Form page).
