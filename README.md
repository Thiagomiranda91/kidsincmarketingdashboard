...
- "Net Followers" on the Facebook/Instagram pages is computed as the change
  in the running follower-count metric from the start to the end of the
  selected window, not a direct "gained minus lost" API field — Meta doesn't
  expose gains and losses separately anymore.
