...
import { fetchNetFollowerChange, fetchInstagramMediaStats, fetchAdStats } from "../../lib/metaClient";
...
export default async function handler(req, res) {
  try {
    ...
    const [netFollowers, mediaStats, adStats] = await Promise.all([
      fetchNetFollowerChange({ objectId: igUserId, metric: "follower_count", since: startDate, until: endDate }),
